<div class="chatbox_container h-full flex flex-col bg-gray-300 overflow-y-auto">
    <!-- Header -->
    ...
    <!-- Chatbox -->
    <div class="chatbox_body flex-grow px-2 py-3 space-y-6 overflow-y-auto bg-slate-950">

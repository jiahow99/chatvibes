<div class="chatbox_container h-full flex flex-col justify-between bg-gray-300 m-0 p-0">
    <div class="m-0 p-0">
        <!-- Header -->
        ...
        <!-- Chatbox -->
        <div class="chatbox_body h-full px-2 py-3 space-y-6 overflow-y-hidden bg-slate-950">

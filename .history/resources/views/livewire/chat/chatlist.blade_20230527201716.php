<div>
    ...
    <div class="chatlist_body">
        <div class="chat row m-0 pl-4 pr-2 py-2 bg-slate-400">
            <div class="col-2 m-0 p-0">
                <img src="{{ asset('img/profile-2.jpg') }}" class="w-14 h-14 object-cover object-center rounded-full" alt="profile">
            </div>
            <div class="col-7">
                <div class="text-[#F6F1F1]">Name</div>
                <div class="text-[#F6F1F1] truncate">Contentasdasdasdsadasdsadasjkasjkdj</div>
            </div>

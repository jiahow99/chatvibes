<div class="h-full flex flex-col bg-gray-300 ">
    ...
    <!-- Chatbox -->
    <div class="chatbox_body flex-grow-1 h-24 px-2 py-3 space-y-6 bg-slate-950 overflow-y-auto">
    ...
    <!-- Send message -->
    <div class="chatbox_footer mt-auto relative">
        <div class="col-3 absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-[120%] bg-slate-500/90 px-1 py-2 rounded-full text-center text-white">
            He is typing ...
        </div>

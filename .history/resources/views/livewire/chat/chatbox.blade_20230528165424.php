<div class="chatbox_container h-full flex flex-col bg-gray-300">
    <!-- Header -->
    ...
    <!-- Chatbox -->
    <div class="chatbox_body max-h-64 h-full px-2 py-3 space-y-6 overflow-y-auto bg-slate-950">
    ...
    <!-- Send message -->
    <div class="chatbox_footer mt-auto h-[20%]">

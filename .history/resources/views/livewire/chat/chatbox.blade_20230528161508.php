<div class="chatbox_container h-full flex flex-col justify-between">
    <div >
        ...
        <div class="chatbox_body px-2 py-3 space-y-6">
            <div class="col-9 bg-blue-500 text-white p-3 rounded-xl">
                ...
                <div class="w-full text-right time space-x-2 mt-2">
                    <span class="my-auto">5 minutes ago</span>
                    <span class="my-auto"><i class="fa-solid fa-eye"></i></span>
                </div>
            </div>

            <div class="col-9 bg-slate-300 ml-auto p-3 rounded-xl">

<div class="chatbox_container h-full flex flex-col justify-between bg-gray-300">
    <div>
        <!-- Header -->
        ...
        <!-- Chatbox -->
        <div class="chatbox_body h-full px-2 py-3 space-y-6 bg-slate-900">
    ...
    <!-- Send message -->
    <div class="chatbox_footer bg-red-200">

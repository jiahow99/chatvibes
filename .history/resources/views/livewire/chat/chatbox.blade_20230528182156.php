<div class="h-full flex flex-col  ">
    ...
    <div class="chatbox_header row m-0 p-0 py-2 bg-slate-300">
        <div class="col-1 m-0 p-0 my-auto outline">
            <i class="fa-solid fa-arrow-left-long text-2xl ml-4"></i>
        </div>
        <div class="col-8 row mx-auto lg:m-0 p-0 outline">
            <div class="col-5 row outline mx-auto">
                <div class="col-4 m-0 p-0">
                    <img src="{{ asset('img/profile-2.jpg') }}" class="w-14 h-14 object-cover object-center rounded-full" alt="profile">
                </div>
                <div class="col m-0 p-0 my-auto font-bold">
                    John
                </div>
            </div>
        </div>
        <div class="col-2 hidden lg:flex ml-auto mr-3 p-0 space-x-5 justify-center items-center outline">

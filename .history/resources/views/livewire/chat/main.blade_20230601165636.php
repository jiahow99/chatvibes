<div>
    ...
    <script>
        $(document).ready(function(){
            ...
            Livewire.on('message_sent', function(conversationId, messageId) {
                scrollToBottom('.chatbox_body');
            });
            Livewire.on('conversation_selected', function(conversationId, messageId) {
                scrollToBottom('.chatbox_body');
            });
        }); 
    </script>

<div class="h-full flex flex-col bg-gray-300 ">
    ...
    <!-- Chatbox -->
    <div class="chatbox_body flex-grow-1 h-24 px-2 py-3 space-y-6 bg-slate-950 overflow-y-auto relative">
        ...
        <div class="col-4 absolute bottom-3 left-1/2 bg-slate-500 px-1 py-2 rounded-full">He is typing ...</div>
    </div>

    <!-- Send message -->
    <div class="chatbox_footer mt-auto">

<div class="h-full flex flex-col  ">
    ...
    <div class="chatbox_header row m-0 p-0 py-2 bg-slate-300">
        ...
        <div class="col-8 row m-0 p-0 outline mx-auto text-center justify-center">
            <div class="col-2 m-0 p-0">
                <img src="{{ asset('img/profile-2.jpg') }}" class="w-14 h-14 object-cover object-center rounded-full" alt="profile">
            </div>
            <div class="col-10 m-0 p-0 my-auto font-bold">John</div>
        </div>
        <div class="col-2 flex ml-auto mr-3 p-0 space-x-5 justify-center items-center outline">

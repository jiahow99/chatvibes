...
class Chatbox extends Component
{
    ...
    public function push_message(Conversation $conversation, Message $message)
    {
        ...
        $this->messages = $this->format_messages(collect($conversation->messages)->sortBy('created_at')->toArray(), $conversation['sender_id']);
    ...
    private function format_messages(array $messages, string $sender_id)
    {
        // Format conversation
